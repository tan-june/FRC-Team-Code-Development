...
Shooter::Shooter():
    shooter(73, rev::CANSparkMaxLowLevel::MotorType::kBrushless)
{
...
void Shooter::SpinFlywheelPID(double RPM){
    shooterpid->SetReference(RPM, rev::CANSparkMax::ControlType::kVelocity, 0, 0.0, rev::SparkMaxPIDController::ArbFFUnits::kVoltage);
}
